...
def main(args):
    ...
    tucker_rank = [1,int(args.tucker_rank),int(args.tucker_rank)]
    ...
    print ("loss",total_loss, "adv acc",adv_acc, "cp acc",cp_acc, "tucker acc",tucker_acc)
    f = open("./result/20200705.txt",'a')
